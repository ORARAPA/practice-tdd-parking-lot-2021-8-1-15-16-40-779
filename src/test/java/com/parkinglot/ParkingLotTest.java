...
public class ParkingLotTest {
    ...
    @Test
    public void should_return_car_parked_in_first_parking_lot_when_park_given_a_super_smart_parking_boy_with_first_parking_lot_has_one_parked_car_second_lot_has_two_parked_cars_and_a_car() {
        //given
        List<ParkingLot> parkingLots = new ArrayList<>();
        ParkingLot parkingLot1 = new ParkingLot();
        ParkingLot parkingLot2 = new ParkingLot();
    ...
    @Test
    public void should_return_right_car_for_each_ticket_when_fetch_twice_given_a_super_smart_parking_boy_manage_two_parking_lots_with_parked_cars_and_two_parking_tickets() {
        //given
        List<ParkingLot> parkingLots = new ArrayList<>();
        ParkingLot parkingLot1 = new ParkingLot();
        ParkingLot parkingLot2 = new ParkingLot();
    ...
    @Test
    public void should_return_error_unrecognized_ticket_when_fetch_given_a_super_smart_parking_boy_managing_two_parking_lots_and_an_unrecognized_ticket() {
        //given
        List<ParkingLot> parkingLots = new ArrayList<>();
        ParkingLot parkingLot1 = new ParkingLot();
        ParkingLot parkingLot2 = new ParkingLot();
    ...
    @Test
    public void should_return_error_unrecognized_ticket_when_fetch_given_a_super_smart_parking_boy_managing_two_parking_lots_and_a_used_ticket() {
        //given
        List<ParkingLot> parkingLots = new ArrayList<>();
        ParkingLot parkingLot1 = new ParkingLot();
        ParkingLot parkingLot2 = new ParkingLot();
